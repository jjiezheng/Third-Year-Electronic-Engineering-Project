...
DeclareShader('Vertex.GL30', Vert )
DeclareShader('Vertex.GL31', Vert )
DeclareShader('Vertex.GL32', Vert )
DeclareShader('Vertex.GL33', Vert )

DeclareShader('Vertex.GL40', Vert )
DeclareShader('Vertex.GL41', Vert )
...
void main(void)
{
  ...
  //gl_FragColor = vec4( chromaticResult.rgb,chromaticResult.a ) + noiseResult;
  FragColour = vec4( radialBlurResult.rgb,radialBlurResult.a ) + noiseResult;
  //gl_FragColor = vec4(BlendOverlay(original.rgb, vignetteResult.rgb*0.35 ),original.a);
  //gl_FragColor = vec4(BlendOverlay(original.rgb, vignetteResult.rgb*0.35 ),original.a) + noiseResult;
  //gl_FragColor = original;
}
...
DeclareShader('Fragment.GL30', Frag )
DeclareShader('Fragment.GL31', Frag )
DeclareShader('Fragment.GL32', Frag )
DeclareShader('Fragment.GL33', Frag )

DeclareShader('Fragment.GL40', Frag )
DeclareShader('Fragment.GL41', Frag )
