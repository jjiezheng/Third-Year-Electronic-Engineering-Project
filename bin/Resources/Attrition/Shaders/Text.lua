...
void main()
{
    ...
    gl_FragColor = vec4(gl_Color.rgb, original.a*gl_Color.a );
}
...
DeclareShader('Fragment.GL20.Glow', oldStyleFragColor )
DeclareShader('Fragment.GL21.Glow', oldStyleFragColor )

DeclareShader('Fragment.GL30.Glow', oldStyleFragColor )
DeclareShader('Fragment.GL31.Glow', oldStyleFragColor )
DeclareShader('Fragment.GL32.Glow', oldStyleFragColor )
DeclareShader('Fragment.GL33.Glow', oldStyleFragColor )

DeclareShader('Fragment.GL40.Glow', oldStyleFragColor )
DeclareShader('Fragment.GL41.Glow', oldStyleFragColor )
